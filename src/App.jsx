...
const PHONE = "5518997491325";

function waLink(msg) {
    return `https://wa.me/${PHONE}?text=${encodeURIComponent(msg)}`;
}

const WA_AGENDAR = waLink("Olá, Arielli! Vi seu site e gostaria de agendar um horário. 😊");
const WA_ORCAMENTO = waLink("Olá, Arielli! Gostaria de solicitar um orçamento personalizado.");
const WA_FOOTER = waLink("Olá, Arielli! Gostaria de agendar um horário pelo WhatsApp. 😊");
...
function AnimatedButton({children = "Agendar Agora", href = WA_AGENDAR}) {
...
export default function App() {
    ...
    const portfolio = [
        {
            src: "https://images.unsplash.com/photo-1548313093-370cf4ba3892?w=900&auto=format&fit=crop&q=60",
            alt: "Tranças"
        },
        {
            src: "https://images.unsplash.com/photo-1549417229-7686ac5595fd?w=900&auto=format&fit=crop&q=60",
            alt: "Noiva"
        },
        {
            src: "https://images.unsplash.com/photo-1492175742197-ed20dc5a6bed?w=900&auto=format&fit=crop&q=60",
            alt: "Ondas"
        },
        {
            src: "https://images.unsplash.com/photo-1523264114838-feca761983c4?w=900&auto=format&fit=crop&q=60",
            alt: "Coque"
        },
        {
            src: "https://images.unsplash.com/photo-1643216583837-f6d664d48eac?w=900&auto=format&fit=crop&q=60",
            alt: "Bridal"
        },
        {
            src: "https://images.unsplash.com/photo-1593575620619-602b4ddf6e96?w=900&auto=format&fit=crop&q=60",
            alt: "Solto"
        },
    ];
        ...
        <>
                    ...
                    <div className="glass-nav" style={{
                        ...
                        <div style={{display: "flex", alignItems: "center", gap: 10}}>
                            <svg width="8" height="8" viewBox="0 0 8 8">
                                <circle cx="4" cy="4" r="4" fill="#ec4899"/>
                            </svg>
                            <span className="cormorant" style={{
                                fontSize: "1.25rem",
                                fontWeight: 400,
                                letterSpacing: ".02em"
                            }}>Arielli Styllus</span>
                        </div>
            ...
            <main style={{maxWidth: 1280, margin: "0 auto", padding: "0 1rem"}}>
                <section style={{
                    ...
                    borderRadius: 32,
                    marginTop: "1rem",
                    boxShadow: "0 8px 40px rgba(236,72,153,.06)",
                    overflow: "hidden",
                    position: "relative"
                }}>
                    <div style={{
                        ...
                        <span className="fade-in fi-1" style={{
                            fontSize: ".68rem",
                            color: "#aaa",
                            letterSpacing: ".12em",
                            textTransform: "uppercase",
                    ...
                    <div style={{padding: "0 2rem", borderBottom: "1px solid rgba(0,0,0,.06)"}}>
                        <h1 className="hero-title" style={{
                            ...
                            <span className="line-reveal" style={{display: "block"}}><span className="line-inner lr-1"
                                                                                           style={{
                                                                                               display: "block",
                                                                                               fontFamily: "'Inter',sans-serif"
                                                                                           }}>ARIELLI</span></span>
                            <span className="line-reveal" style={{display: "block"}}><span
                                className="line-inner lr-2 italic-chic" style={{
                                display: "block",
                                color: "#b8a0a8",
                                paddingLeft: ".08em"
                            }}>Styllus.</span></span>
                    ...
                    <div className="hero-ed-bottom"
                         style={{display: "grid", gridTemplateColumns: "1fr 1.5fr 1fr", minHeight: 460}}>
                        <div className="hero-ed-col-l fade-in fi-2" style={{
                            ...
                            <div style={{display: "flex", flexDirection: "column", gap: "1.5rem"}}>
                                {[{n: `${c1}+`, l: "Anos de experiência"}, {
                                    n: `${c2}+`,
                                    l: "Noivas atendidas"
                                }, {n: `${(c3 / 1000).toFixed(1)}K`, l: "Seguidores no Instagram"}].map(({n, l}, i) => (
                                    <div key={i} style={{
                                        display: "flex",
                                        alignItems: "baseline",
                                        gap: "1rem",
                        ...
                        <div className="hero-ed-col-r fade-in fi-3" style={{
                            padding: "2rem 2.5rem",
                            display: "flex",
                            flexDirection: "column",
                            justifyContent: "space-between",
                            ...
                            <div style={{display: "flex", justifyContent: "flex-end"}}>
                                <div style={{position: "relative", width: 90, height: 90}}>
                                    <svg viewBox="0 0 100 100" width="90" height="90" className="spin-label">
                                        <path id="circ" d="M 50,50 m -35,0 a 35,35 0 1,1 70,0 a 35,35 0 1,1 -70,0"
                                              fill="none"/>
                                        <text fontSize="10.5" fill="#9ca3af" letterSpacing="3.2"
                                              fontFamily="Inter,sans-serif">
                            ...
                            <div style={{borderTop: "1px solid #f0f0f0", paddingTop: "1rem"}}>
                                <p style={{
                                    ...
                                    lineHeight: 1.6,
                                    textTransform: "uppercase"
                                }}>Atendimento em domicílio<br/>Parapuã e região · SP</p>
                            </div>
                        </div>
                    </div>
                    <div className="marquee-outer">
                        <div className="marquee-track">
                            {[...Array(2)].flatMap((_, ri) => ["Noivas", "Penteados", "Festas", "Alisamentos", "Madrinhas", "Eventos", "Domicílio", "Premium", "Casamentos"].map((item, i) => (
                ...
                <section id="sobre" className="mobile-section-pad" style={{
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            textTransform: "uppercase",
                            letterSpacing: ".1em"
                        }}>/ Sobre a Profissional</p>
                        <span style={{fontSize: ".75rem", fontWeight: 600, color: "#9ca3af"}}>(01)</span>
                    </div>
                    <h2 className="cormorant"
                        style={{fontSize: "clamp(2.5rem,6vw,4.5rem)", color: "#111", marginBottom: "2.5rem"}}>
                        ...
                        <div>
                            ...
                            <div style={{padding: "0 1rem"}}>
                                <p style={{
                                    ...
                                    lineHeight: 1.8,
                                    marginBottom: "1rem"
                                }}>Criando belezas autênticas e intencionais que contam a sua história no dia mais
                                ...
                                <p style={{
                                    ...
                                    lineHeight: 1.7,
                                    marginBottom: "1rem"
                                }}>Com 13 anos dedicados à arte de transformar cabelos, minha abordagem mistura o
                                    clássico com a leveza da emoção. Cada penteado é composto com intenção, focando em
                                    realçar a beleza genuína de cada cliente que senta na minha cadeira.</p>
                                <p style={{fontSize: ".95rem", color: "#6b7280", lineHeight: 1.7}}>Trabalho com noivas e
                                    eventos, garantindo que o seu visual não apenas pareça perfeito nas fotos, mas se
                                    mantenha impecável e confortável durante toda a festa.</p>
                            </div>
                        </div>
                        <div style={{display: "flex", flexDirection: "column", gap: "1.5rem"}}>
                            <div style={{
                                ...
                                <div style={{display: "flex", flexDirection: "column", gap: "1.25rem"}}>
                                    {[{n: "13+", l: "Anos de Experiência"}, {
                                        n: "500+",
                                        l: "Noivas Atendidas"
                                    }, {n: "2.5K", l: "Seguidores no Instagram"}].map(({n, l}) => (
                                        <div key={l}><p className="cormorant" style={{
                                            fontSize: "2.5rem",
                                            color: "#111",
                                            lineHeight: 1
                                        }}>{n}</p><p
                                            style={{fontSize: ".8rem", color: "#6b7280", marginTop: "0.2rem"}}>{l}</p>
                                        </div>))}
                                </div>
                            </div>
                            <div style={{
                                ...
                                <div style={{display: "flex", alignItems: "center", gap: 8, marginBottom: "1.5rem"}}>
                                    <span style={{fontSize: "1rem", color: "#f9a8d4"}}>✂</span><span style={{
                                    fontSize: ".7rem",
                                    fontWeight: 600,
                                ...
                                <div style={{display: "flex", flexDirection: "column", gap: "1rem"}}>
                                    {[["Penteados para Noivas", "Premium"], ["Penteados para Festas", "Eventos"], ["Alisamento / Progressiva", "Tratamento"], ["Escova e Finalização", "Dia a dia"]].map(([a, b], i, arr) => (
                                        <div key={a} style={{
                                            ...
                                            paddingBottom: i < arr.length - 1 ? ".5rem" : undefined
                                        }}><span style={{fontSize: ".85rem", color: "rgba(255,255,255,0.9)"}}>{a}</span><span
                                            style={{fontSize: ".7rem", color: "rgba(255,255,255,0.5)"}}>{b}</span>
                                        </div>))}
                                </div>
                            </div>
                        </div>
                ...
                <section id="servicos" className="mobile-section-pad" style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <h2 className="cormorant"
                                style={{fontSize: "clamp(2.5rem,6vw,4.5rem)", color: "#111", lineHeight: 1.05}}>Pacotes
                    ...
                    <div className="slider-dots-mobile"
                         style={{justifyContent: "center", gap: 6, marginTop: "1.25rem"}}>
                ...
                <section id="portfolio" className="mobile-section-pad" style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <h2 className="cormorant" style={{
                                ...
                                color: "#fff",
                                lineHeight: 1.05
                            }}>Últimos<br/><span className="italic-chic" style={{color: "#f9a8d4"}}>trabalhos.</span>
                            </h2>
                        </div>
                    ...
                    <div style={{width: '100%', height: '70vh', minHeight: '600px', position: 'relative'}}>
                        <DomeGallery images={portfolio} fit={0.9} minRadius={850} maxVerticalRotationDeg={0}
                                     segments={32} dragDampening={2.6} grayscale={false}/>
                    </div>
                </section>
                ...
                <section style={{
                    ...
                    {[
                        {
                            src: "https://images.unsplash.com/photo-1593575620619-602b4ddf6e96?w=900&auto=format&fit=crop&q=60",
                            s: {top: -20, left: -40, transform: "rotate(-7deg)", width: 280}
                        },
                        {
                            src: "https://images.unsplash.com/photo-1608245536505-9bab008d00d3?w=900&auto=format&fit=crop&q=60",
                            s: {top: -10, right: -30, transform: "rotate(6deg)", width: 250}
                        },
                        {
                            src: "https://images.unsplash.com/photo-1743017521050-d2655a8d4410?w=900&auto=format&fit=crop&q=60",
                            s: {bottom: -30, left: 10, transform: "rotate(-12deg)", width: 290}
                        },
                        {
                            src: "https://images.unsplash.com/photo-1583322695560-25fc86f56017?w=900&auto=format&fit=crop&q=60",
                            s: {bottom: 40, right: -10, transform: "rotate(8deg)", width: 260}
                        },
                    ...
                    <div style={{
                        ...
                        <div style={{display: "flex", justifyContent: "space-between", marginBottom: "2rem"}}>
                            ...
                            style={{fontSize: ".75rem", color: "#9ca3af", fontWeight: 600}}>(100+)</span>
                        </div>
                        <h2 className="cormorant"
                            style={{fontSize: "clamp(2.5rem,6vw,4rem)", color: "#111", lineHeight: 1.1}}>
                            "Fiquei apaixonada no resultado! A Arielli transformou meu dia da noiva em algo
                            absolutamente <span className="italic-chic" style={{color: "#f472b6"}}>mágico.</span>"
                        </h2>
                        <p style={{color: "#6b7280", marginTop: "1.5rem", fontSize: ".9rem", letterSpacing: ".02em"}}>—
                            Fernanda S., Noiva 2024</p>
                        <a href="https://www.instagram.com/arielli_styllus" target="_blank" rel="noopener noreferrer"
                           style={{
                               display: "inline-flex",
                               alignItems: "center",
                    ...
                    <div style={{padding: "5rem clamp(1.5rem,5vw,4rem) 0"}}>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <p style={{fontSize: ".9rem", color: "rgba(255,255,255,.9)", marginBottom: ".5rem"}}>📍
                                    Parapuã, SP</p>
                                <p style={{
                                    fontSize: ".9rem",
                                    color: "rgba(255,255,255,.5)",
                                    lineHeight: 1.6
                                }}>Especialista em Penteados.<br/>13 anos transformando vidas.</p>
                            </div>
                            <div>
                                <p style={{
                                    fontSize: ".7rem",
                                ...
                                <div style={{display: "flex", flexDirection: "column", gap: "1rem"}}>
                                    <a href="https://www.instagram.com/arielli_styllus" target="_blank"
                                       rel="noopener noreferrer"
                                       style={{color: "#fff", textDecoration: "none", fontSize: ".9rem"}}>Instagram
                                        ↗</a>
                                    <a href={WA_FOOTER} target="_blank" rel="noopener noreferrer"
                                       style={{color: "#fff", textDecoration: "none", fontSize: ".9rem"}}>WhatsApp ↗</a>
                                </div>
                            </div>
                            <div>
                                <p style={{
                        ...
                        <div style={{
                            ...
                            <p style={{fontSize: ".75rem", color: "rgba(255,255,255,.4)"}}>© 2026 Arielli Styllus. Todos
